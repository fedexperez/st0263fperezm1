...
class DBObjects(DBPostgresql):
    ...
    def list_crobjects(self):
        ...
        for crO in list_crobjects:
            c = CRObject(None, crO['key'], crO['value'])
    ...
    def search_crobjects(self, filters):
        ...
        list_crobjects = self.get_by_filters(filters)
